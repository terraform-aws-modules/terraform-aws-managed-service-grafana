...
| <a name="vpc_configuration"></a> [vpc\_configuration](#vpc\_configuration) | Map of vpc configuration settings for creating grafana workspace within an AWS VPC | `map` | `{}` | no |
